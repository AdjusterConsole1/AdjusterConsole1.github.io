	...
	reader.onload = function (e) {
		try {
			...
			if (Array.isArray(jsonContent) && jsonContent.length > 0) {
				const output = formatJsons(jsonContent);
				document.getElementById('textarea2').value = output;
				const countLefts = jsonContent.length;
				...
				document.getElementById('left1').innerHTML = remaining + brLine + countInts;
				document.getElementById('left2').innerHTML = remaining + brLine + countLefts;
				document.getElementById('left3').innerHTML = remaining + brLine + countLefts;
			} else {
...
function formatPart(part, indent) {
	...
	if (countLefts === 1) {
		document.getElementById('next1').innerHTML = next + brLine + part.partNumber;
		document.getElementById('next2').innerHTML = next + brLine + part.partNumber;
		document.getElementById('next3').innerHTML = next + brLine + parseFloat(part.priceEach).toFixed(2);
	}
	localStorage.setItem("countLefts", countLefts);
	return result;
}
...
function resetAutoCopyComponents() {
	...
	document.getElementById('copy1').innerHTML = copied + brLine + dash;
	document.getElementById('copy2').innerHTML = copied + brLine + dash;
	document.getElementById('copy3').innerHTML = copied + brLine + dash;
	document.getElementById('next1').innerHTML = next + brLine + dash;
	document.getElementById('next2').innerHTML = next + brLine + dash;
	document.getElementById('next3').innerHTML = next + brLine + dash;
	document.getElementById('left1').innerHTML = remaining + brLine + dash;
	document.getElementById('left2').innerHTML = remaining + brLine + dash;
	document.getElementById('left3').innerHTML = remaining + brLine + dash;
		...
		if (firstLine !== '') {
			navigator.clipboard.writeText(firstLine).then(() => {
				...
				if (countAlls === 1) {
					...
					document.getElementById('next1').innerHTML = next + brLine + NextLine;
				}
				document.getElementById('copy1').innerHTML = copied + brLine + firstLine;
				document.getElementById('left1').innerHTML = remaining + brLine + countAlls;
		...
		if (firstLine !== '') {
			navigator.clipboard.writeText(firstLine).then(() => {
				...
				if (countPNs === 1) {
					...
					document.getElementById('next2').innerHTML = next + brLine + NextLine;
				}
				document.getElementById('copy2').innerHTML = copied + brLine + firstLine;
				document.getElementById('left2').innerHTML = remaining + brLine + countPNs;
		...
		if (firstLine !== '') {
			navigator.clipboard.writeText(firstLine).then(() => {
				...
				if (countPrices === 1) {
					...
					document.getElementById('next3').innerHTML = next + brLine + NextLine;
				}
				document.getElementById('copy3').innerHTML = copied + brLine + firstLine;
				document.getElementById('left3').innerHTML = remaining + brLine + countPrices;
