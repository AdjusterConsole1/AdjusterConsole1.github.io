document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll('.sop_btn.neu').forEach(el => el.addEventListener('click', function() { showSOP(this.id); }));
    ...
    document.getElementById("serN")?.addEventListener("click", () => showNote("serN"));
    document.getElementById("serS")?.addEventListener("click", () => saveRecord("serS"));
    document.getElementById("serD")?.addEventListener("click", () => delRecord("serD"));
    document.getElementById("incN")?.addEventListener("click", () => showNote("incN"));
    document.getElementById("incS")?.addEventListener("click", () => saveRecord("incS"));
    document.getElementById("incD")?.addEventListener("click", () => delRecord("incD"));
    document.getElementById("rec0N")?.addEventListener("click", () => showNote("rec0N"));
    document.getElementById("rec0S")?.addEventListener("click", () => saveRecord("rec0S"));
    document.getElementById("rec0D")?.addEventListener("click", () => delRecord("rec0D"));
    document.getElementById("rec1N")?.addEventListener("click", () => showNote("rec1N"));
    document.getElementById("rec1S")?.addEventListener("click", () => saveRecord("rec1S"));
    document.getElementById("rec1D")?.addEventListener("click", () => delRecord("rec1D"));
    document.getElementById("rec2N")?.addEventListener("click", () => showNote("rec2N"));
    document.getElementById("rec2S")?.addEventListener("click", () => saveRecord("rec2S"));
    document.getElementById("rec2D")?.addEventListener("click", () => delRecord("rec2D"));
    document.getElementById("rec3N")?.addEventListener("click", () => showNote("rec3N"));
    document.getElementById("rec3S")?.addEventListener("click", () => saveRecord("rec3S"));
    document.getElementById("rec3D")?.addEventListener("click", () => delRecord("rec3D"));
    document.getElementById("rec4N")?.addEventListener("click", () => showNote("rec4N"));
    document.getElementById("rec4S")?.addEventListener("click", () => saveRecord("rec4S"));
    document.getElementById("rec4D")?.addEventListener("click", () => delRecord("rec4D"));
    document.getElementById("rec5N")?.addEventListener("click", () => showNote("rec5N"));
    document.getElementById("rec5S")?.addEventListener("click", () => saveRecord("rec5S"));
    document.getElementById("rec5D")?.addEventListener("click", () => delRecord("rec5D"));
