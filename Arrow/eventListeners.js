document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('conopdeny')?.addEventListener('click', function() { outputText(this.id, 'clip'); closeSlide() });
    document.getElementById('sludgedeny')?.addEventListener('click', function() { outputText(this.id, 'clip'); closeSlide() });
    document.getElementById('waitdeny')?.addEventListener('click', function() { outputText(this.id, 'clip'); closeSlide() });
    document.getElementById('T41')?.addEventListener('click', function() { outputText(this.id, 'clip'); closeSlide() });
    document.getElementById('T51')?.addEventListener('click', function() { outputText(this.id, 'clip'); closeSlide() });
    document.getElementById('T61')?.addEventListener('click', function() { outputText(this.id, 'clip'); closeSlide() });
    document.getElementById('T71')?.addEventListener('click', function() { outputText('picR', 'clip'); closeSlide() });
    document.getElementById('T81')?.addEventListener('click', function() { outputText('recR', 'clip'); closeSlide() });
    document.getElementById('T91')?.addEventListener('click', function() { outputText('noansR', 'clip'); closeSlide() });
